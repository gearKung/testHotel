...
const routes = [
  ...
  { 
    ...
    children: [ 
      ...
      // { path: 'list',                   name: 'OwnerHotelList',          component: OwnerHotelList },
      // { path: 'registerHotel',          name: 'OwnerHotelRegister',      component: OwnerHotelRegister },
      // { path: ':hotelId/details',       name: 'OwnerHotelDetail',        component: OwnerHotelDetail },
      // { path: ':hotelId/edit',          name: 'OwnerHotelEdit',          component: OwnerHotelEdit },
      // { path: ':hotelId/rooms',         name: 'OwnerHotelRoom',          component: OwnerHotelRoom },
      // { path: ':hotelId/registerRoom',  name: 'OwnerHotelRoomRegister',  component: OwnerHotelRoomRegister },
      // { path: ':hotelId/rooms/:roomId/edit',  name: 'OwnerHotelRoomEdit',  component: OwnerHotelRoomEdit },
